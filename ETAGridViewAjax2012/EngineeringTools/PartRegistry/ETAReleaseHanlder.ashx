<%@ WebHandler Language="C#" Class="ETAReleaseHanlder" %>
using System;
...
public class ETAReleaseHanlder : IHttpHandler, IRequiresSessionState
{
    ...
    private static void QueryFormA(HttpContext context)
    {
    ...
    private static void QueryFormC(HttpContext context)
    {
        // Get total result rows without paging
        int count = 0; //list.Count; //查询总条数
        int pagesize = 10;//Convert.ToInt32(context.Request["pageSize"]);
