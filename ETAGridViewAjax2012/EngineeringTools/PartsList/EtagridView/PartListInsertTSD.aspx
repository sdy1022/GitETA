<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartListInsertTSD.aspx.cs"
    Inherits="EngineeringTools_PartsList_EtagridView_PartListInsertTSD" %>
            ...
            <td align="left">
                <asp:GridView ID="Gvwpartlist" runat="server" BorderWidth="1px" BackColor="LightGoldenrodYellow"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:RadioButton ID="rdoselect" runat="server" OnCheckedChanged="rdoselect_CheckedChanged"
                                    />
                            </ItemTemplate>
                        </asp:TemplateField>
