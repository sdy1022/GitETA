<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartsListTSDSubSelect.aspx.cs"
    Inherits="EngineeringTools_PartsList_EtagridView_PartsListTSDSubSelect" %>
...
<body alink="loginfo()">
        ...
        <tr>
            <td align="left">
                <asp:GridView ID="Gvwpartlist" runat="server" BorderWidth="1px" BackColor="LightGoldenrodYellow"
                    ...
                    OnRowDataBound="Gvwpartlist_RowDataBound" Style="margin-top: 42px">
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:RadioButton ID="rdoselect" CssClass="cssrbt" runat="server" OnCheckedChanged="rdoselect_CheckedChanged" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="LEVEL">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbllevel" runat="server" Text='<%# Bind("TreeLevel") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <div>
        <table border="1" cellpadding="1" cellspacing="0" frame="void" width="100%">
            <tr bordercolor="Blue">
                <th align="left" width="150">
                    <font size="2">Module:&nbsp;<asp:Label ID="Label6" runat="server"></asp:Label>
                    </font>
                </th>
                <th align="left" width="400">
                    <input name="txtCode50" type="hidden" value="1" />
                    ...
                    <input name="txtID0" type="hidden" value="45996" />
                    <input name="txtDesignnumber0" type="hidden" value="N9JU-2" />
                    <asp:TextBox ID="txtSubName1" runat="server" Width="380px"></asp:TextBox>
                </th>
                <th align="left">
                    <asp:TextBox ID="txtSubCode1" runat="server"></asp:TextBox>
                </th>
            </tr>
            <tr bordercolor="Blue">
                <th align="left">
                    <font size="2">Original Package:&nbsp;<asp:Label ID="Label7" runat="server"></asp:Label>
                    </font>
                </th>
                <th align="left">
                    <asp:TextBox ID="txtSubName2" runat="server" Width="380px"></asp:TextBox>
                </th>
                <th align="left">
                    <asp:TextBox ID="txtSubCode2" runat="server"></asp:TextBox>
                </th>
            </tr>
            <tr bordercolor="Blue">
                <th align="left">
                    <font size="2">Page:&nbsp;<asp:Label ID="Label8" runat="server"></asp:Label>
                    </font>
                </th>
                <th align="left">
                    <asp:TextBox ID="txtSubName3" runat="server" Width="380px"></asp:TextBox>
                </th>
                <th align="left">
                    <asp:TextBox ID="txtSubCode3" runat="server"></asp:TextBox>
                </th>
            </tr>
            <tr bordercolor="Blue">
                <th align="left" class="style1">
                ...
                <th align="left" class="style1">
                    <asp:TextBox ID="txtSubName4" runat="server" Width="380px"></asp:TextBox>
                </th>
                <th align="left" class="style1">
                    <asp:TextBox ID="txtSubCode4" runat="server"></asp:TextBox>
                </th>
            </tr>
        </table>
    </div>
            ...
            <td>
                ...
                <table cellspacing="0" cellpadding="1" width="100%" border="1">
                    ...
                    <tr>
                        ...
                        <%-- <td bordercolor="blue" align="center">
                                <font size="1">
                                    <asp:TextBox ID="txtov5" runat="server" EnableTheming="False" 
                                        MaxLength="99"></asp:TextBox></font>
                            </td>--%>
                    </tr>
                    <tr>
                        ...
                        <%--  <td bordercolor="blue" align="center" class="style4">
                            ...
                            <td bordercolor="blue" align="center" class="style4">
                                <font size="1">
                                    <asp:Image ID="imgrev4" runat="server" ImageUrl="http://colweb01/eta/images/RevA.gif" />
                                </font>
                            </td>--%>
                        <td bordercolor="blue" align="center">
                        ...
                        <%-- <td bordercolor="blue" align="center">
                                <font size="1">
                                    <asp:TextBox ID="txtov6" runat="server" EnableTheming="False" 
                                        MaxLength="99"></asp:TextBox></font>
                            </td>--%>
                    </tr>
                </table>
...
<script language="jscript">
    ...
    function ChangeRowColor(rowID, partno) {
    ...
    //"uncheckOthersradio('Gvwpartlist_ctl02_rdoselect','56581-U2100-71');"
    ...
    function uncheckOthersradio(id, partno) {

       //         alert('sddssd');
        //        alert(<%=Gvwpartlist.ClientID %>.value);

        //  var list = $(".cssrbt").find("input:radio");
        var elm = document.getElementsByTagName('input');

        var parent = document.getElementById("<%=Gvwpartlist.ClientID %>");
        elm = parent.getElementsByTagName('input');
        //  alert(elm.length);
        for (var i = 0; i < elm.length; i++) {
        ...
        var txtcode1 = partno.substr(0, 4);
        var txtcode2 = partno.substr(5, 3);
        var txtcode3 = partno.substr(9, 2);
       
        document.getElementById('<%=txtSubCode1.ClientID%>').value = txtcode1;
        document.getElementById('<%=txtSubCode2.ClientID%>').value = txtcode2;
        document.getElementById('<%=txtSubCode3.ClientID%>').value = txtcode3;
