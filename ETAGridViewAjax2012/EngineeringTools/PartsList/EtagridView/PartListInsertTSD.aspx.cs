...
public partial class EngineeringTools_PartsList_EtagridView_PartListInsertTSD : System.Web.UI.Page
{
    #region Property
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        string result = CommonDB.InsertTSDNewPartListWithTransactionForInsert(ref result2, dtmaketable);
    ...
    protected void Gvwpartlist_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                CheckBox control = (CheckBox)e.Row.Cells[0].FindControl("rdoselect");
